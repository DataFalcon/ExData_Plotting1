...
# Finally we add the legend to this plot. 
# "topright" is the legend location, the next parameter includes the labels in a vector
# lwd is the line width (value 1 in this case) "col" are the colors of the three lines 
# and text.col are the colors of the labels
